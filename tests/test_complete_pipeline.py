...
def test_individual_stages():
    ...
    try:
from src.advanced.frame_preprocessor import FramePreprocessor
from src.advanced.multi_model_detector import MultiModelFaceDetector
from src.advanced.face_tracker import FaceTracker
from src.quality.face_quality_checker import FaceQualityChecker
from src.advanced.face_enhancement import FaceEnhancer
from src.advanced.multi_embeddings import MultiEmbeddingGenerator
from src.advanced.advanced_matcher import AdvancedMatcher
from src.advanced.post_processor import PostProcessor
